...
def box_iou(box1, box2):
    ...
    return inter / union  # shape: [box1.size(0), box2.size(0)]

def nms_pure(boxes, scores, iou_threshold=0.5):
    """Pure PyTorch implementation of NMS (no torchvision dependency)"""
...
def non_max_suppression(
    ...
    for xi, (x, xk) in enumerate(zip(prediction, xinds)):  # image index, (preds, preds indices)
        ...
        if rotated:
            ...
            i = nms_pure(boxes, scores, iou_thres)
